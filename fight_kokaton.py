...
class Score:
    def __init__(self):
        self.font = pg.font.SysFont("hgep006", 25)
        self.point = 0

    def count_s(self, point): #scoreのカウントをする関数
        self.point += point * 10

    def draw(self, screen): #scoreを表示する関数
        text = self.font.render("{:04d}".format(self.point), True, (0, 0, 0))
